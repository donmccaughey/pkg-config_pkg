...
tag-message := A signed and notarized universal installer package for \`pkg-config\` $(version), built with libiconv $(libiconv_version).
tag-title := pkg-config $(version) for macOS rev $(revision)
ver := $(version)$(rev)
